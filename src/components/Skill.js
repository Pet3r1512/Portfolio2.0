...
const involvedItem = [
  ...
  },
  {
    ...
    list: "HTML5, CSS3 (CSS pre-processor: Sass, CSS Frameworks: Bootstrap, TailwindCSS), JavaScript (JavaScript Library: React Js), ReactJs Framework: NextJs, Database Model: Prisma",
  },
  {
...
const learningItem = [
  {
    name: "Database, Microsoft SQL Sever, GraphQL, Git",
  },
  {
